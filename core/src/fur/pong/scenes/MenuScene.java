...
public class MenuScene implements Scene {
    ...
    private final List<GlyphLayout> whiteMenuItems = Arrays.asList(new GlyphLayout(whiteFont, "Start game"), new GlyphLayout(whiteFont, "Settings"), new GlyphLayout(whiteFont, "Exit"));
    private final List<GlyphLayout> blackMenuItems = Arrays.asList(new GlyphLayout(blackFont, "Start game"), new GlyphLayout(blackFont, "Settings"), new GlyphLayout(blackFont, "Exit"));

    private final List<Runnable> menuActions = Arrays.asList(() -> reutrnedScene = (SharedState.settingsSet) ? new GameScene(batch, 0) : new SettingsScene(batch, new GameScene(batch, 0)),
                                                             () -> reutrnedScene = new SettingsScene(batch, new MenuScene(batch)),
